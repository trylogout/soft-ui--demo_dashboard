<template>
	<div>
      ...
      <a-layout v-if="isMobile" v-bind:style=" sidebarCollapsed ? 'padding-left: 0px !important' : 'padding-left: 250px !important' ">

        <!-- Layout Header's Conditionally Fixed Wrapper -->
        <DashboardHeader
            :sidebarCollapsed="sidebarCollapsed"
            :navbarFixed="navbarFixed"
            :navbarTheme="sidebarTheme"
        ...
        <!-- / Sidebar Overlay -->
			...
			<a-layout v-else v-bind:style=" sidebarCollapsed ? 'padding-left: 130px !important' : 'padding-left: 250px !important' ">

	...
	<component :is="navbarFixed ? 'a-affix' : 'div'" :offset-top="top">
		...
		<a-layout-header>
			<a-row type="flex">
				...
				<a-col :span="24" :md="6" class="menu">

          <a-row>
            <!-- Header Breadcrumbs -->
            <a-breadcrumb v-if="$route.name !== 'Home'">
          ...
          <div style="display: flex">
              ...
              <a-button v-if="sidebarCollapsed" type="link" class="sidebar-toggler" @click="$emit('toggleSidebar', ! sidebarCollapsed) , resizeEventHandler()">
                <svg width="20" height="20" viewBox="0 0 24 24" focusable="false" class="chakra-icon css-bsv9g"><path fill="black" d="M 3 5 A 1.0001 1.0001 0 1 0 3 7 L 21 7 A 1.0001 1.0001 0 1 0 21 5 L 3 5 z M 3 11 A 1.0001 1.0001 0 1 0 3 13 L 21 13 A 1.0001 1.0001 0 1 0 21 11 L 3 11 z M 3 17 A 1.0001 1.0001 0 1 0 3 19 L 21 19 A 1.0001 1.0001 0 1 0 21 17 L 3 17 z"></path></svg>
              </a-button>

              <a-button v-if="!sidebarCollapsed" type="link" class="sidebar-toggler" @click="$emit('toggleSidebar', ! sidebarCollapsed) , resizeEventHandler()">
                <svg width="20" height="20" stroke="black" fill="black" stroke-width="0" viewBox="0 0 24 24" focusable="false" class="chakra-icon css-14ym1b2" xmlns="http://www.w3.org/2000/svg"><path d="M22 18.0048C22 18.5544 21.5544 19 21.0048 19H12.9952C12.4456 19 12 18.5544 12 18.0048C12 17.4552 12.4456 17.0096 12.9952 17.0096H21.0048C21.5544 17.0096 22 17.4552 22 18.0048Z" fill="black"></path><path d="M22 12.0002C22 12.5499 21.5544 12.9954 21.0048 12.9954H2.99519C2.44556 12.9954 2 12.5499 2 12.0002C2 11.4506 2.44556 11.0051 2.99519 11.0051H21.0048C21.5544 11.0051 22 11.4506 22 12.0002Z" fill="black"></path><path d="M21.0048 6.99039C21.5544 6.99039 22 6.54482 22 5.99519C22 5.44556 21.5544 5 21.0048 5H8.99519C8.44556 5 8 5.44556 8 5.99519C8 6.54482 8.44556 6.99039 8.99519 6.99039H21.0048Z" fill="black"></path></svg>
              </a-button>

<template>
	...
	<a-layout-sider
		...
		class="sider-primary"
		breakpoint="lg"
		:collapsed-width="isMobile?'0px':'120px'"
		width="260px"
    ...
    @mouseenter="mouseOver=true; sidebarCollapsed?$emit('toggleSidebar', false):mouseOver=false;"
    @mouseleave="$emit('toggleSidebar', mouseOver)"
  >

			<div  v-if="!sidebarCollapsed" class="brand">
        <span>Weho App Icon</span>
      </div>
      <div v-else class="brand">
        <span>WH</span>
            ...
            <span v-if="!sidebarCollapsed" class="label">Home</span>
					</router-link>
				...
				<a-menu-item>
					<router-link to="/users">
						...
						<span v-if="!sidebarCollapsed"  class="label">User Management</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/billing">
						...
						<span v-if="!sidebarCollapsed"  class="label">Billing</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/profile">
						...
						<span v-if="!sidebarCollapsed" class="label">Profile</span>
					</router-link>
				</a-menu-item>
        ...
        <a-sub-menu key="sub1">
          ...
          <span v-if="!sidebarCollapsed">Debug</span>
          </span>
